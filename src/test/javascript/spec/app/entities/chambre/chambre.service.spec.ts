...
describe('Service Tests', () => {
  describe('Chambre Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(ChambreService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Chambre(0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Chambre', () => {
        ...
        service.create(new Chambre()).subscribe(resp => (expectedResult = resp.body));
