...
import ch.itsforward.ecolifeexpedition.domain.Client;
import ch.itsforward.ecolifeexpedition.repository.ClientRepository;
...
/**
 * REST controller for managing {@link ch.itsforward.ecolifeexpedition.domain.Client}.
 */
@RestController
@RequestMapping("/api")
@Transactional
